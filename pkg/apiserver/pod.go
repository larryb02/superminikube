...
func ListAllNamespacePods(kvstore *redis.Client) ([]podv2.Pod, error) {
...
func GetPodByUid(nodename string, uid string, kvstore *redis.Client) (podv2.Pod, error) {
...
func CreatePod(nodename string, spec *spec.ContainerSpec, kvstore *redis.Client) (podv2.Pod, error) {
